import json
from scraper import get_news_links, get_news_htmls, process_news_htmls, process_news_website
...
def main():
    ...
    for website in websites:
        if website["enable"]:
            ...
            # news_htmls = get_news_htmls(website_name, news_links)
            # news_content = process_news_htmls(website_name, news_htmls)
